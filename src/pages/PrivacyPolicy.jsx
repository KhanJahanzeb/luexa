...
export default function PrivacyPolicy() {
  return (
    <Layout title={"Privacy Policy | Lunexa Studios"} description={"How Lunexa Studios collects, uses, and protects your information across Lunexa Digital, Launchpad, Connect, and Media."} activePath={"/privacy-policy"} showLeadPopup={false}>
        ...
        <div className={"container"}>
          <div className={"row"}>
            <div className={"col-lg-12"}>
              ...
              <p>
                We collect the information you give us directly — your name, email, phone number, and billing details when you contact us, request a quote, or purchase our services. We also collect usage data automatically, such as your browser type, device information, IP address, and the pages you visit, and project data you share with us, including files and brand materials needed to deliver our services.
              </p>
              <h3 className={"inner-hd3"}>
                2. Information Use
              </h3>
              <p>
                We use your information to communicate with you about your project, deliver the services you've engaged us for, process payments, send opt-in communications, and meet our legal obligations.
              </p>
              <h3 className={"inner-hd3"}>
                3. Information Sharing
              </h3>
              <p>
                We do not sell or rent your personal data. We may share information with trusted service providers who help us operate our business, and with legal authorities when required by law.
              </p>
              <h3 className={"inner-hd3"}>
                4. Data Security
              </h3>
              <p>
                We employ industry-standard security measures to protect your information. That said, no method of transmission over the internet is 100% secure, and we cannot guarantee absolute security.
              </p>
              <h3 className={"inner-hd3"}>
                5. Cookies
              </h3>
              <p>
                Our website uses cookies for analytics and to improve your browsing experience. You can modify your browser settings to decline cookies at any time.
              </p>
              <h3 className={"inner-hd3"}>
                6. Your Rights
              </h3>
              <p>
                You can request access to, correction of, or deletion of your personal data, and you can withdraw from our marketing communications at any time.
              </p>
              <h3 className={"inner-hd3"}>
                7. External Links
              </h3>
              <p>
                Our website may link to third-party sites. Lunexa Studios is not responsible for the privacy practices or content of those external websites.
              </p>
              <h3 className={"inner-hd3"}>
                8. Policy Updates
              </h3>
              <p>
                We may update this policy from time to time. Changes will be posted on this page along with a revised effective date.
              </p>
              <h3 className={"inner-hd3"}>
                9. Contact Us
              </h3>
              <p>
                Questions about this policy? Reach us at <a href={"mailto:info@lunexastudios.com"}>info@lunexastudios.com</a> or <a href={"tel:210 360 9849"}>210 360 9849</a>.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className={"row"}>
            <div className={"col-md-12"}>
              <div className={"text-center"}>
                ...
                <h4>
                  Our team is happy to walk you through how we handle your information — reach out any time.
                </h4>
              </div>
