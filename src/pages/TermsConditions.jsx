...
export default function TermsConditions() {
  return (
    <Layout title={"Terms & Conditions | Lunexa Studios"} description={"The terms that govern working with Lunexa Studios across Lunexa Digital, Launchpad, Connect, and Media."} activePath={"/terms-and-conditions"} showLeadPopup={false}>
      <section className={"sec-pad nobanner-sec inner-sec"}>
        <div className={"container"}>
          <div className={"row"}>
            <div className={"col-lg-12"}>
              ...
              <h3 className={"inner-hd3"}>
                1. General Overview
              </h3>
              <p>
                By engaging Lunexa Studios for any project, you agree to be bound by these Terms &amp; Conditions. They apply to every division of our business — Lunexa Digital, Lunexa Launchpad, Lunexa Connect, and Lunexa Media — and to every proposal, quote, or plan you accept from us.
              </p>
              <h3 className={"inner-hd3"}>
                2. Services
              </h3>
              <p>
                Lunexa Studios provides graphic design, branding, and visual identity services, web and app development, photography and videography, digital marketing, and business consulting. The exact scope of any engagement is defined in the proposal or plan you agree to.
              </p>
              <h3 className={"inner-hd3"}>
                3. Payments &amp; Refunds
              </h3>
              <p>
                Payment follows the schedule agreed in your proposal or contract. Deposits are non-refundable once a project begins, and delays in payment may result in project suspension. Refunds are evaluated individually at Lunexa Studios' discretion — see our <a href={"/refund-policy"}>Refund Policy</a> for full details.
              </p>
              <h3 className={"inner-hd3"}>
                4. Intellectual Property
              </h3>
              <p>
                Creative work remains the property of Lunexa Studios until final payment is received, at which point ownership transfers to the client. Lunexa Studios reserves the right to showcase completed work in our portfolio, on social media, and in promotional materials, unless a written agreement states otherwise.
              </p>
              <h3 className={"inner-hd3"}>
                5. Client Responsibilities
              </h3>
              <p>
                Clients must provide timely materials and feedback, ensure they hold proper licensing for any content they supply, and communicate any requested changes in writing. Delays in providing these may affect project timelines.
              </p>
              <h3 className={"inner-hd3"}>
                6. Confidentiality
              </h3>
              ...
              <p>
                Lunexa Studios' liability under any engagement is limited to the total amount paid by the client for that engagement. We are not responsible for indirect or consequential damages, including lost profits.
              </p>
              <h3 className={"inner-hd3"}>
                8. Termination
              </h3>
              <p>
                Either party may terminate an engagement with written notice. The client must pay for all work completed up to the termination date.
              </p>
              <h3 className={"inner-hd3"}>
                9. Revisions &amp; Deliverables
              </h3>
              <p>
                Projects include a reasonable number of revisions as stated in the proposal. Additional revisions beyond that scope may incur extra charges.
              </p>
              <h3 className={"inner-hd3"}>
                10. Governing Law
              </h3>
              ...
              <p>
                Questions about these terms? Reach us at <a href={"mailto:info@lunexastudios.com"}>info@lunexastudios.com</a> or <a href={"tel:210 360 9849"}>210 360 9849</a>, Texas, USA.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className={"row"}>
            <div className={"col-md-12"}>
              <div className={"text-center"}>
                <h1>
                  READY TO WORK WITH LUNEXA?
                </h1>
                <h4>
                  Have a question about these terms before you get started? Our team is here to help.
                </h4>
              </div>
      ...
      <div className={"popup-layout popup-layout1"} id={"popup-layout"}>
        <div className={"popup-inner"}>
          ...
          <div className={"col-md-5 no-pad"}>
            ...
            <form id={"popupform"} action={"test-mail.php"} method={"POST"} className={"js-recaptcha-form"}>
