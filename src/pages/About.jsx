...
export default function About() {
  return (
    <Layout title={"About Lunexa Studios | Digital Growth Partner"} description={"Meet the team and values behind Lunexa Studios — the digital growth partner behind Lunexa Digital, Launchpad, Connect, and Media."} activePath={"/about"}>
                  ...
                  <div className={"col-lg-6"}>
                    <div className={"txt-container"}>
                      <div className={"ban-txt"}>
                        ...
                        <a href={"javascript:;"} className={"btn-cstm leadfrm"} rel={"About Us"}>
                          Get Started
                        </a>
          ...
          <div className={"row"}>
            <div className={"col-lg-12"}>
              ...
              <p className={"large-pra"}>
                At Lunexa, we specialize in crafting innovative digital marketing strategies that drive real business growth. Our expertise ensures your brand stays ahead in the competitive digital landscape. Get to know the passionate team behind the strategies, the values that guide us, and the mission that fuels our growth.
              </p>
          ...
          <div className={"row"}>
            <div className={"col-md-12"}>
              <h2 className={"sec-hd text-center"}>
                ...
                <span>
                  In the fast-paced digital world, choosing the right marketing partner makes all the difference. Lunexa crafts strategies that deliver measurable success — not just campaigns.
                </span>
              </h2>
              <ul className={"type-ul"}>
                <li className={"type-li1"}>
                  <div className={"type-box"}>
                    ...
                    <p>
                      Every decision we make is backed by real-time analytics and honest reporting, so you always know exactly where your investment is going and why.
                    </p>
                ...
                <li className={"type-li2"}>
                  <div className={"type-box"}>
                    ...
                    <p>
                      We work as an extension of your team, combining cutting-edge marketing techniques with your industry knowledge to keep you ahead of the competition.
                    </p>
                    <a href={"/contact"} className={"view-more"}>
                      Read More
                    </a>
                ...
                <li className={"type-li3"}>
                  <div className={"type-box"}>
                    ...
                    <p>
                      Clear insights and performance tracking mean you always know your ROI. We measure success the same way you do — in real business outcomes.
                    </p>
                    <a href={"/contact"} className={"view-more"}>
                      Read More
                    </a>
          ...
          <div className={"row"}>
            <div className={"col-md-12"}>
              <h3 className={"color-white animated bounceInUp"} data-id={"1"}>
                <strong>
                  2.7k+ Positive Reviews, 90% Improved Projects
                </strong>
                <span>
                  Real results, not just promises — our clients see measurable growth across web, e-commerce, outsourcing, and media engagements.
                </span>
              </h3>
              <ul>
          ...
          <div className={"row"}>
            <div className={"col-md-12"}>
              <h2 className={"sec-hd text-center"}>
                ...
                <span>
                  A small, senior team that stays hands-on with every account — no hand-offs to a call center.
                </span>
              </h2>
              <ul className={"type-ul"}>
                <li className={"type-li1"}>
        ...
        <div className={"container"}>
          <div className={"col-lg-12"}>
            ...
            <ul className={"process-ul"}>
              ...
              <li id={"aprocess1"} className={"prc-all prc-1 active"}>
                <h4>
                  Discovery &amp; Consult
                </h4>
            ...
            <div className={"process-content"}>
              ...
              <div className={"process4 process-tabs"}>
                ...
                <div className={"col-md-5"}>
                  ...
                  <p>
                    We track performance and refine consistently, so your growth compounds quarter over quarter, not just campaign over campaign.
                  </p>
                </div>
                <div className={"col-md-5 text-right"}>
          ...
          <div className={"row"}>
            <div className={"col-md-12"}>
              <div className={"text-center"}>
                ...
                <h4>
                  Tell us about your business and we'll share a growth strategy tailored to your goals.
                </h4>
              </div>
              ...
              <div className={"slidefrm-bdy"}>
                ...
                <div className={"checkbox-wrap"}>
                  ...
                  <label htmlFor={"check1"}>
                    I agree with Lunexa Studio Policy and provide my consent to receive B2B marketing communications from Lunexa Studio Design
                  </label>
                </div>
                <div className={"checkbox-wrap"}>
