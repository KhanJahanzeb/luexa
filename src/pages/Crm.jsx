...
export default function Crm() {
  return (
    <Layout title={"Website design service by expert designers in USA"} description={"Professional logo design service in USA. Get creative concepts, 100% money back guarantee and dedicated design team."} activePath={"/crm"}>
      <div className={"ban-sec-slider"}>
        <div className={"banner-sec"}>
          <div className={"ban-slide"}>
            <div className={"banner-pic"}>
              <img src={"/assets/images/CRMban.jpg"} alt={""} />
            </div>
                  ...
                  <div className={"col-lg-6"}>
                    <div className={"txt-container"}>
                      <div className={"ban-txt"}>
                        ...
                        <br />
                        <h1>
                          Powerful CRM Solutions to Streamline Sales & Boost Growth
                        </h1>
                        <h4>
                          CRM and chatbots, your brand can build stronger
                          <br />
                          relationships, streamline operations, and maximize
                          <br />
          ...
          <div className={"row"}>
            <div className={"col-lg-5 col-md-5 animatedParent"} data-sequence={"150"}>
              <h2 className={"lg-hd animated bounceInLeft"} data-id={"1"}>
                How Are CRM & Chatbots Beneficial for
                <strong>
                  Your Business?
                </strong>
              </h2>
              <div className={"concept-sldr-txt"}>
                <div>
                  <p className={"large-pra animated bounceInLeft"} data-id={"3"}>
                    enhance customer engagement and streamline business operations. A CRM helps manage relationships, track leads, and boost sales efficiency. AI chatbots provide instant support, automate responses, and improve customer satisfaction. Together, they drive growth, save time, and optimize customer interactions.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className={"row"}>
            <div className={"col-md-12"}>
              <h2 className={"sec-hd text-center"}>
                Optimize & Streamline with Smart CRM Solutions
                <span>
                  We specialize in providing innovative and efficient CRM solutions to streamline your business operations.
                </span>
              </h2>
              <ul className={"type-ul"}>
                <li className={"type-li1"}>
                  <a href={"#"}>
                    <div className={"type-box"}>
                      <i className={"sprite-icnc sprite-icn-staticc"}></i>
                      <h5>
                        Stronger Customer Relationships
                      </h5>
                      <p>
                        A CRM system helps businesses track customer interactions, preferences, and history, enabling personalized engagement. It strengthens relationships by providing tailored communication and seamless follow-ups. With a structured database, businesses can maintain long-term customer loyalty. Enhanced customer experience leads to higher retention rates.
                      </p>
                    </div>
                  </a>
                </li>
                <li className={"type-li2"}>
                  <a href={"#"}>
                    <div className={"type-box"}>
                      <i className={"sprite-icncr sprite-icn-ecommercecr"}></i>
                      <h5>
                        Data-Driven Insights
                      </h5>
                      <p>
                        Data-driven insights in CRM help businesses understand customer behavior and preferences. They enable personalized interactions, improving engagement and retention rates. With real-time analytics, businesses can optimize sales and marketing strategies. A CRM with strong insights enhances efficiency, growth, and decision-making, leading to long-term business success.
                      </p>
                    </div>
                  </a>
                </li>
                <li className={"type-li3"}>
                  <a href={"#"}>
                    <div className={"type-box"}>
                      <i className={"sprite-icncrm sprite-icn-cmscrm"}></i>
                      <h5>
                        Increased Sales & Conversions
                      </h5>
                      <p>
                        A CRM streamlines lead tracking, automates sales processes, and ensures no opportunity is missed. It helps sales teams nurture prospects and close deals faster. By analyzing customer behavior, businesses can personalize sales approaches. Improved organization leads to higher conversion rates and revenue growth.
                      </p>
                    </div>
                  </a>
                </li>
                <li className={"type-li4"}>
                  <a href={"#"}>
                    <div className={"type-box"}>
                      <i className={"sprite-icncrmm sprite-icn-portalcrmm"}></i>
                      <h5>
                        ChatBot
                      </h5>
                      <p>
                        A chatbot enhances customer support by providing instant responses and 24/7 assistance. It automates interactions, reducing wait times and improving user experience. With AI-driven capabilities, chatbots handle inquiries efficiently and boost engagement. Seamlessly integrated into websites and apps, they streamline communication and support.
                      </p>
                    </div>
                  </a>
                </li>
            ...
            <div className={"portfolio-tar logoport"}>
              <ul className={"row portfolio-box"}>
                <li className={"col-lg-4 col-md-4 col-md-4"}>
                  <a href={"/assets/images/Websites/001.jpeg"} data-fancybox={"logodesign"}>
                    <span className={"iconport"}>
                      <i className={"fa fa-search-plus"} aria-hidden={"true"}></i>
                    </span>
                    <img src={"/assets/images/Websites/web9-01.png"} className={"img-responsive"} alt={""} />
                  </a>
                </li>
                <li className={"col-lg-4 col-md-4"}>
                  <a href={"/assets/images/Websites/002.jpeg"} data-fancybox={"logodesign"}>
                    <span className={"iconport"}>
                      <i className={"fa fa-search-plus"} aria-hidden={"true"}></i>
                    </span>
                    <img src={"/assets/images/Websites/web2-01.png"} className={"img-responsive"} alt={""} />
                  </a>
                </li>
                <li className={"col-lg-4 col-md-4"}>
                  <a href={"/assets/images/Websites/003.jpeg"} data-fancybox={"logodesign"}>
                    <span className={"iconport"}>
                      <i className={"fa fa-search-plus"} aria-hidden={"true"}></i>
                    </span>
                    <img src={"/assets/images/Websites/web8-01.png"} className={"img-responsive"} alt={""} />
                  </a>
                </li>
                <li className={"col-lg-4 col-md-4"}>
                  <a href={"/assets/images/Websites/004.jpeg"} data-fancybox={"logodesign"}>
                    <span className={"iconport"}>
                      <i className={"fa fa-search-plus"} aria-hidden={"true"}></i>
                    </span>
                    <img src={"/assets/images/Websites/web7-01.png"} className={"img-responsive"} alt={""} />
                  </a>
                </li>
                <li className={"col-lg-4 col-md-4"}>
                  <a href={"/assets/images/Websites/005.jpeg"} data-fancybox={"logodesign"}>
                    <span className={"iconport"}>
                      <i className={"fa fa-search-plus"} aria-hidden={"true"}></i>
                    </span>
                    <img src={"/assets/images/Websites/web6-01.png"} className={"img-responsive"} alt={""} />
                  </a>
                </li>
                <li className={"col-lg-4 col-md-4"}>
                  <a href={"/assets/images/Websites/006.jpeg"} data-fancybox={"logodesign"}>
                    <span className={"iconport"}>
                      <i className={"fa fa-search-plus"} aria-hidden={"true"}></i>
                    </span>
                    <img src={"/assets/images/Websites/web1-01.png"} className={"img-responsive"} alt={""} />
                  </a>
                </li>
                <li className={"col-lg-4 col-md-4"}>
                  <a href={"/assets/images/Websites/007.jpeg"} data-fancybox={"logodesign"}>
                    <span className={"iconport"}>
                      <i className={"fa fa-search-plus"} aria-hidden={"true"}></i>
                    </span>
                    <img src={"/assets/images/Websites/web5-01.png"} className={"img-responsive"} alt={""} />
                  </a>
                </li>
                <li className={"col-lg-4 col-md-4"}>
                  <a href={"/assets/images/Websites/008.jpeg"} data-fancybox={"logodesign"}>
                    <span className={"iconport"}>
                      <i className={"fa fa-search-plus"} aria-hidden={"true"}></i>
                    </span>
                    <img src={"/assets/images/Websites/web4-01.png"} className={"img-responsive"} alt={""} />
                  </a>
                </li>
                <li className={"col-lg-4 col-md-4"}>
                  <a href={"/assets/images/Websites/009.jpeg"} data-fancybox={"logodesign"}>
                    <span className={"iconport"}>
                      <i className={"fa fa-search-plus"} aria-hidden={"true"}></i>
                    </span>
                    <img src={"/assets/images/Websites/web3-01.png"} className={"img-responsive"} alt={""} />
                  </a>
                </li>
                <li className={"col-lg-4 col-md-4"}>
                  <a href={"/assets/images/Websites/001.jpeg"} data-fancybox={"logodesign"}>
          ...
          <div className={"row"}>
            <div className={"col-md-12"}>
              <h3 className={"color-white animated bounceInUp"} data-id={"1"}>
                <strong>
                  Ready To Place Your CRM Or Chatbot Order?
                </strong>
                <span>
        ...
        <div className={"container"}>
          <div className={"row"}>
            <div className={"col-lg-12"}>
              <h2 className={"sec-hd text-center"}>
                We Have Carefully Crafted Our CRM & Chatbot Packages To Suit Businesses Of All Sizes
                <span>
                  Get exclusive deals on advanced solutions designed to enhance efficiency and boost growth
                </span>
              </h2>
                  ...
                  <ul className={"pack-list animatedParent"} data-sequence={"100"}>
                    <li className={"normal-offer-pack"}>
                      ...
                      <ul className={"pack-features pack-spec-scroll"}>
                        ...
                        <li>
                          Hosted by Hosted by Lunexa Studio
                        </li>
                        <li>
                          Includes:1 shared project
                        </li>
                        <li>
                    ...
                    <li className={"always-active pkg-active"}>
                      ...
                      <ul className={"pack-features pack-spec-scroll"}>
                        ...
                        <li>
                          unlimited test ones Hosted by Hosted by Lunexa Studio
                        </li>
                        <li>
                          10k workflow executions
                        </li>
                        ...
                        <li>
                          unlimited test ones $50 / month
                        </li>
                        <li>
                          10k executions, 15 active workflows $120 / month
                        </li>
                        <li>
                          50k executions, 50 active workflows Custom plan
                        </li>
                        <li>
                          Custom executions, custom active workflows Everything in Starter plan, plus:
                        </li>
                        <li>
                          3 shared projects
                        </li>
                    ...
                    <li>
                      ...
                      <h3 className={"pack-title"}>
                        ...
                        <br />
                        <span>
                          Ideal for businesses requirements Contact us
                        </span>
                      </h3>
                      <ul className={"pack-features pack-spec-scroll"}>
                        <li>
                        ...
                        <li>
                          Self-hosted (or hosted by Hosted by Lunexa Studio) Everything in Pro plan, plus:
                        </li>
                        <li>
                      ...
                      <a href={"/contact"} className={"pack-ordernow pck-details"} rel={"8f14e45fceea167a5a36dedd4bea2543"} amount={"$896"} type={"web"}>
                        Contact Us
                      </a>
                      <ul className={"pkg-cta"}>
                        <li>
