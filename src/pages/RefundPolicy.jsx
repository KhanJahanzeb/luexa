...
export default function RefundPolicy() {
  return (
    <Layout title={"Logo design service by expert designers in USA"} description={"Professional logo design service in USA. Get creative concepts, 100% money back guarantee and dedicated design team."} activePath={"/refund-policy"} showLeadPopup={false}>
        ...
        <div className={"container"}>
          <div className={"row"}>
            <div className={"col-lg-12"}>
              ...
              <p>
                Clients are eligible for a 100% refund if their project has not been initiated within 10 days of purchase.
              </p>
              <h3 className={"inner-hd3"}>
                Project Hold & Cancellation
              </h3>
              <p></p>
              <ul>
                <li>
                  • Clients may place a project on hold for up to one month. If the client remains unreachable after this period, the project will be canceled with no refund.
                </li>
                <li>
                  • Refunds cannot be requested after three revision requests.
                </li>
              </ul>
              <p></p>
              <h3 className={"inner-hd3"}>
              ...
              <p>
                Refunds must be formally requested and will be reviewed case by case.
              </p>
              <h3 className={"inner-hd3"}>
                Fraudulent Transactions
              </h3>
              <p>
                If a fraudulent credit card transaction is detected, the project will be canceled without a refund.
              </p>
              <p>
                <b>
                  Lunexa Studio strives to deliver exceptional service, ensuring client satisfaction at every step. If you have any concerns, feel free to reach out!
                </b>
              </p>
            </div>
          </div>
