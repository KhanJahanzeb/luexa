...
export default function AllInOne() {
  return (
    <Layout title={"Website design service by expert designers in USA"} description={"Professional logo design service in USA. Get creative concepts, 100% money back guarantee and dedicated design team."} activePath={"/all-in-one"}>
      !
      ...
      <div className={"banner-sec sm-bann push-pg-bann all-in-pkg-bann"}>
        <div className={"ban-txt-box"}>
          <div className={"container"}>
            <div className={"row"}>
              <div className={"col-lg-6 col-sm-6"}>
                <div className={"txt-container"}>
                  <div className={"ban-txt txt-sm"}>
                    <br />
                    <br />
                    <br />
                    <br />
                    ...
                    <br />
                    <h1>
                      Lunexa Studio Design Brand Exclusive
                      <br />
                      <span className={"colr-black"}>
                        Complete Branding Solution
                      </span>
                    </h1>
                    <div className={"col-md-6 no-pad"}>
                      <ul className={"chk-bullets"}>
                        <li>
                    ...
                    <div className={"bann-price"}>
                      ...
                      <a href={"javascript:;"} className={"blue-btn"} rel={"6512bd43d9caa6e02c990b0a82652dca"}>
                        Order Now
                      </a>
                    </div>
                  </div>
              ...
              <div className={"col-lg-6 col-sm-6"}>
                ...
                <br />
                <br />
                <img src={"/assets/images/mega-package-img.png"} alt={""} />
              </div>
            </div>
          </div>
        </div>
      </div>
      <section className={"special-packg-sec all-in-pkg"}>
        <div className={"container"}>
          <div className={"row"}>
            <div className={"col-md-6"}>
              <h2>
            ...
            <div className={"col-md-6"}>
              <ul className={"special-pkg-cta"}>
                ...
                <li>
                  <a href={"tel:+1 (855) 262-3282"}>
                    <i className={"fa fa-phone"} aria-hidden={"true"}></i>
                    +1 (855) 262-3282
                  </a>
                </li>
                <li>
                  <a href={"javascript:;"} className={"orange-btn"} rel={"6512bd43d9caa6e02c990b0a82652dca"}>
                    Order Now
                  </a>
                </li>
              </ul>
            ...
            <div className={"col-md-12"}>
              <p>
                We aim to provide best solutions for all the branding needs. You will get a perfectly designed logo adding value to your brand and along with that many more branding services to make you stand out from the crowd. Our dedicated designing team will be available 24/7 through our chat service.
              </p>
              <div className={"col-md-4"}>
                <div className={"megapack-infobox megapack-points-left animated bounceInUp go"} data-id={"1"}>
                  <div className={"megapack-title"}>
                    Logo Design
                  </div>
                  <div className={"clearfix"}></div>
                  <div className={"megapack-points"}>
                    <ul>
                      <li>
                        Unlimited Concepts
                      </li>
              ...
              <div className={"col-md-4"}>
                ...
                <div className={"megapack-infobox megapack-points-left animated bounceInUp go"} data-id={"1"}>
                  ...
                  <div className={"megapack-points"}>
                    <ul>
                      <li>
                        Any 4 of Your Choice
                      </li>
                      <li>
                        Facebook, LinkedIn, G+, Twitter, YouTube
                      </li>
                    </ul>
                  </div>
                </div>
              ...
              <div className={"clearfix"}></div>
              <div className={"bann-price text-center"}>
                <div className={"new-price orng-colr"}>
                  $1499
                </div>
                <div className={"old-price white-colr"}>
                  <span>
                    $7495
                  </span>
                  80%off
              ...
              <div className={"slidefrm-bdy"}>
                ...
                <div className={"checkbox-wrap"}>
                  ...
                  <label htmlFor={"check1"}>
                    I agree with Lunexa Studio Policy and provide my consent to receive B2B marketing communications from Lunexa Studio
                  </label>
                </div>
                <div className={"checkbox-wrap"}>
