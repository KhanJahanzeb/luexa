...
import { IconChat, IconChevronUp, IconClock, IconClose, IconGauge, IconPhone, IconUser } from "../components/icons/Icon.jsx";
...
export default function Contact() {
  ...
  return (
    <Layout title={"Contact Lunexa Studios | Free Consultation"} description={"Ready to elevate your digital presence? Reach out to Lunexa Studios for a custom strategy across web, e-commerce, outsourcing, and media."} activePath={"/contact"}>
                  ...
                  <div className={"col-lg-6"}>
                    <div className={"txt-container"}>
                      <div className={"ban-txt"}>
                        ...
                        <a href={"javascript:;"} className={"btn-cstm leadfrm"} rel={"Contact"}>
                          Get Started
                        </a>
                      </div>
                    </div>
      ...
      <section className={"sec-pad"}>
        <div className={"container"}>
          <div className={"row"}>
            <div className={"col-lg-8 noguttar"}>
                ...
                <div className={"contact-form-box"}>
                  <form action="#" method="POST" onSubmit={handleContactSubmit}>
                    ...
                    <div className="row">
                      ...
                      <div className="col-lg-12">
                        <input type="submit" value={status === "sending" ? "Sending…" : "Send a Query"} disabled={status === "sending"} />
                      </div>
                      {status === "sent" && (
                        <div className="col-lg-12">
            ...
            <div className={"col-lg-4 noguttar"}>
