...
export default function Website() {
  return (
    <Layout title={"Lunexa Digital — Web, App & Growth Solutions | Lunexa Studios"} description={"We design websites, apps, and digital strategies that fuel real business growth — not just clicks."} activePath={"/website"}>
                  ...
                  <div className={"col-lg-6"}>
                    <div className={"txt-container"}>
                      <div className={"ban-txt"}>
                        ...
                        <h4>
                          We design websites, apps, and digital strategies that fuel real business growth — not just clicks.
                        </h4>
                        <ul>
                          <li>
                            Web Development, Mobile Apps, Custom Software &amp; Digital Marketing
                          </li>
                          <li>
                            Data-driven strategies designed to increase traffic, boost conversions, and scale your business
                          </li>
                        </ul>
                        <a href={"javascript:;"} className={"btn-cstm leadfrm"} rel={"Lunexa Digital"}>
                          Get Started
                        </a>
          ...
          <div className={"row"}>
            <div className={"col-lg-5 col-md-5 animatedParent"} data-sequence={"150"}>
              ...
              <div className={"concept-sldr-txt"}>
                <div>
                  <p className={"large-pra animated bounceInLeft"} data-id={"3"}>
                    We don't just build websites or apps — we build digital ecosystems that help businesses scale smarter. Whether you're a startup, a growing e-commerce brand, or an enterprise, our solutions adapt to your goals.
                  </p>
                </div>
              </div>
              <h4>
              ...
              <p className={"large-pra"}>
                8+ Years of Experience on Digital Marketing Services. Explore our multiple specialized divisions — each designed to solve real business challenges and fuel measurable growth.
              </p>
            </div>
              ...
              <ul className={"type-ul"}>
                <li className={"type-li1"}>
                  <div className={"type-box"}>
                    ...
                    <p>
                      Every strategy we create is powered by real-time data, analytics, and deep market insights. We use measurable metrics to guide decisions, optimize campaigns, and deliver consistent performance that aligns with your business goals. With our data-first mindset, you get smarter results — faster and more efficiently.
                    </p>
                ...
                <li className={"type-li2"}>
                  <div className={"type-box"}>
                    ...
                    <p>
                      We combine creativity with modern marketing technology to produce campaigns that truly stand out. From unique branding concepts to engaging content, our innovative ideas help you stay ahead of your competitors and connect with your audience in meaningful ways. We turn imagination into impact.
                    </p>
                    <a href={"/contact"} className={"view-more"}>
                      Read More
                    </a>
                ...
                <li className={"type-li3"}>
                  <div className={"type-box"}>
                    ...
                    <p>
                      We believe in complete transparency. Our detailed performance reports help you track progress, understand what's working, and see your ROI clearly. You get full visibility into your campaign results with easy-to-read metrics, insights, and recommendations for continual improvement.
                    </p>
                    <a href={"/contact"} className={"view-more"}>
                      Read More
                    </a>
                ...
                <li className={"type-li1"}>
                  <a href={"/mobile"}>
                    <div className={"type-box"}>
                      ...
                      <p>
                        iOS &amp; Android apps tailored to your business needs. Smooth, scalable, and future-ready.
                      </p>
                    </div>
                  </a>
                </li>
                <li className={"type-li2"}>
                  <a href={"/crm"}>
                    <div className={"type-box"}>
                      ...
                      <p>
                        CRMs, dashboards, and automation tools. Designed to simplify complex workflows.
                      </p>
                    </div>
                  </a>
                </li>
                <li className={"type-li3"}>
                  <a href={"/seo"}>
                    <div className={"type-box"}>
                      ...
                      <p>
                        SEO, paid ads, and social media campaigns. Data-driven strategies to maximize ROI.
                      </p>
                    </div>
                  </a>
                </li>
                <li className={"type-li4"}>
                  <a href={"/all-in-one"}>
                    <div className={"type-box"}>
                      ...
                      <p>
                        Modern, fast, and user-friendly websites that convert visitors into customers. SEO-optimized and mobile-ready.
                      </p>
                    </div>
                  </a>
                </li>
        ...
        <div className={"container"}>
          <div className={"col-lg-12"}>
            ...
            <ul className={"process-ul"}>
              ...
              <li id={"wprocess1"} className={"prc-all prc-1 active"}>
                <h4>
                  Discovery &amp; Consult
                </h4>
      ...
      <section id={"packages-sec"} className={"tab-pack-box pack-sec sec-pad lp-pack-sec"} data-img={"url(assets/images/portf-bg.jpg)"}>
        <div className={"container"}>
          <div className={"row"}>
            <div className={"col-lg-12"}>
              <h2 className={"sec-hd text-center"}>
                Flexible Pricing Plan for Every Business
                <span>
                  ...
                  <ul className={"pack-list animatedParent"} data-sequence={"100"}>
                    <li className={"less-offer-pack"}>
                      ...
                      <ul className={"pack-features pack-spec-scroll"}>
                        ...
                        <li>
                          Priority Scheduling &amp; Design Requests
                        </li>
                        <li>
                          Monthly Competitor Analysis
                        </li>
                        <li>
                          Quarterly SEO Audit &amp; Growth Planning
                        </li>
                        <li>
                        ...
                        <li>
                          Free Landing Page (Every 6 Months)
                        </li>
                        <li>
                          REPORTING &amp; STRATEGY:
                        </li>
                        ...
                        <li>
                          Best for: businesses seeking a long-term marketing partner — ideal for healthcare, law firms, home services, fitness brands, restaurants, and growing local businesses.
                        </li>
                        <li>
                          Minimum 6-month agreement. Advertising billed separately. Additional content available at preferred client rates.
                        </li>
                      </ul>
