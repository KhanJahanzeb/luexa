...
export default function Reviews() {
  return (
    <Layout title={"Website design service by expert designers in USA"} description={"Professional logo design service in USA. Get creative concepts, 100% money back guarantee and dedicated design team."} activePath={"/reviews"}>
              ...
              <div className={"txt-review-container"}>
                <ul className={"row"}>
                  <li className={"col-lg-6 col-sm-6"}>
                    <div className={"row"}>
                      <div className={"col-lg-2 noguttar-right"}>
                        <div className={"txt-rev-img"}>
                          <img src={"/assets/images/people/testi-author-01.jpg"} alt={""} />
                        </div>
                      </div>
                      <div className={"col-lg-10"}>
                        <div className={"testi-txt-box"}>
                          <p>
                  ...
                  <li className={"col-lg-6 col-sm-6"}>
                    <div className={"row"}>
                      <div className={"col-lg-2 noguttar-right"}>
                        <div className={"txt-rev-img"}>
                          <img src={"/assets/images/people/testi-author-02.jpg"} alt={""} />
                        </div>
                      </div>
                      <div className={"col-lg-10"}>
                        <div className={"testi-txt-box"}>
                  ...
                  <li className={"col-lg-6 col-sm-6"}>
                    <div className={"row"}>
                      <div className={"col-lg-2 noguttar-right"}>
                        <div className={"txt-rev-img"}>
                          <img src={"/assets/images/people/testi-author-03.jpg"} alt={""} />
                        </div>
                      </div>
                      <div className={"col-lg-10"}>
                        <div className={"testi-txt-box"}>
                  ...
                  <li className={"col-lg-6 col-sm-6"}>
                    <div className={"row"}>
                      <div className={"col-lg-2 noguttar-right"}>
                        <div className={"txt-rev-img"}>
                          <img src={"/assets/images/people/testi-author-04.jpg"} alt={""} />
                        </div>
                      </div>
                      <div className={"col-lg-10"}>
                        <div className={"testi-txt-box"}>
                  ...
                  <li className={"col-lg-6 col-sm-6"}>
                    <div className={"row"}>
                      <div className={"col-lg-2 noguttar-right"}>
                        <div className={"txt-rev-img"}>
                          <img src={"/assets/images/people/testi-author-05.jpg"} alt={""} />
                        </div>
                      </div>
                      <div className={"col-lg-10"}>
                        <div className={"testi-txt-box"}>
                  ...
                  <li className={"col-lg-6 col-sm-6"}>
                    <div className={"row"}>
                      <div className={"col-lg-2 noguttar-right"}>
                        <div className={"txt-rev-img"}>
                          <img src={"/assets/images/people/testi-author-06.jpg"} alt={""} />
                        </div>
                      </div>
                      <div className={"col-lg-10"}>
                        <div className={"testi-txt-box"}>
                  ...
                  <li className={"col-lg-6 col-sm-6"}>
                    <div className={"row"}>
                      <div className={"col-lg-2 noguttar-right"}>
                        <div className={"txt-rev-img"}>
                          <img src={"/assets/images/people/testi-author-07.jpg"} alt={""} />
                        </div>
                      </div>
                      <div className={"col-lg-10"}>
                        <div className={"testi-txt-box"}>
                  ...
                  <li className={"col-lg-6 col-sm-6"}>
                    <div className={"row"}>
                      <div className={"col-lg-2 noguttar-right"}>
                        <div className={"txt-rev-img"}>
                          <img src={"/assets/images/people/testi-author-08.jpg"} alt={""} />
                        </div>
                      </div>
                      <div className={"col-lg-10"}>
                        <div className={"testi-txt-box"}>
                  ...
                  <li className={"col-lg-6 col-sm-6"}>
                    <div className={"row"}>
                      <div className={"col-lg-2 noguttar-right"}>
                        <div className={"txt-rev-img"}>
                          <img src={"/assets/images/people/testi-author-09.jpg"} alt={""} />
                        </div>
                      </div>
                      <div className={"col-lg-10"}>
                        <div className={"testi-txt-box"}>
                          <p>
                            Lunexa Studio created a stunning, high-performance website for our business. The design is modern, user-friendly, and optimized for conversions. Our online presence has never been stronger
                          </p>
                          <div className={"row"}>
                            <div className={"col-lg-4"}>
                              <div className={"testi-star"}>
                  ...
                  <li className={"col-lg-6 col-sm-6"}>
                    <div className={"row"}>
                      <div className={"col-lg-2 noguttar-right"}>
                        <div className={"txt-rev-img"}>
                          <img src={"/assets/images/people/testi-author-10.jpg"} alt={""} />
                        </div>
                      </div>
                      <div className={"col-lg-10"}>
                        <div className={"testi-txt-box"}>
                          <p>
                            The team at Lunexa Studio built a sleek and professional website for our fashion brand. The design is stunning, easy to navigate, and optimized for mobile users. We’ve seen a huge boost in online engagement!
                          </p>
                          <div className={"row"}>
                            <div className={"col-lg-4"}>
                              <div className={"testi-star"}>
                  ...
                  <li className={"col-lg-6 col-sm-6"}>
                    <div className={"row"}>
                      <div className={"col-lg-2 noguttar-right"}>
                        <div className={"txt-rev-img"}>
                          <img src={"/assets/images/people/testi-author-11.jpg"} alt={""} />
                        </div>
                      </div>
                      <div className={"col-lg-10"}>
                        <div className={"testi-txt-box"}>
                          <p>
                            Lunexa Studio created a stunning logo that perfectly represents our brand. The design is modern, professional, and visually appealing. It has truly set us apart in the industry
                          </p>
                          <div className={"row"}>
                            <div className={"col-lg-4"}>
                              <div className={"testi-star"}>
                  ...
                  <li className={"col-lg-6 col-sm-6"}>
                    <div className={"row"}>
                      <div className={"col-lg-2 noguttar-right"}>
                        <div className={"txt-rev-img"}>
                          <img src={"/assets/images/people/testi-author-12.jpg"} alt={""} />
                        </div>
                      </div>
                      <div className={"col-lg-10"}>
                        <div className={"testi-txt-box"}>
                          <p>
                            We wanted a logo that captured our brand’s essence, and Lunexa Studio delivered beyond our expectations. Their team was professional, responsive, and extremely creative. Highly recommend!
                            <br />
                            <br />
                            <br />
                          </p>
                  ...
                  <li className={"col-lg-6 col-sm-6"}>
                    <div className={"row"}>
                      <div className={"col-lg-2 noguttar-right"}>
                        <div className={"txt-rev-img"}>
                          <img src={"/assets/images/people/testi-author-13.jpg"} alt={""} />
                        </div>
                      </div>
                      <div className={"col-lg-10"}>
                        <div className={"testi-txt-box"}>
                          <p>
                            Lunexa Studio designed a logo that aligns seamlessly with our brand identity. It’s sleek, memorable, and works perfectly across all platforms. Their expertise and creativity are unmatched!
                            <br />
                            <br />
                          </p>
                          <div className={"row"}>
                  ...
                  <li className={"col-lg-6 col-sm-6"}>
                    <div className={"row"}>
                      <div className={"col-lg-2 noguttar-right"}>
                        <div className={"txt-rev-img"}>
                          <img src={"/assets/images/people/testi-author-14.jpg"} alt={""} />
                        </div>
                      </div>
                      <div className={"col-lg-10"}>
                        <div className={"testi-txt-box"}>
                          <p>
                            Lunexa Studio built an outstanding website for our real estate agency. The design is sleek, easy to navigate, and perfectly showcases our property listings. We’ve seen a significant increase in inquiries since launch
                          </p>
                          <br />
                          <div className={"row"}>
                            <div className={"col-lg-4"}>
                            ...
                            <div className={"col-lg-8"}>
                              <div className={"txt-rev-name"}>
                                Jacob R.,
                                <br />
                                CEO of Elite Property Solutions
                              </div>
                            </div>
                          </div>
                        </div>
                  ...
                  <li className={"col-lg-6 col-sm-6"}>
                    <div className={"row"}>
                      <div className={"col-lg-2 noguttar-right"}>
                        <div className={"txt-rev-img"}>
                          <img src={"/assets/images/people/testi-author-15.jpg"} alt={""} />
                        </div>
                      </div>
                      <div className={"col-lg-10"}>
                        <div className={"testi-txt-box"}>
                          <p>
                            Our online bakery needed a fresh, modern website, and Lunexa Studio delivered beyond expectations. The site is beautifully designed, mobile-friendly, and has improved our online orders tremendously!
                          </p>
                          <div className={"row"}>
                            <div className={"col-lg-4"}>
                              <div className={"testi-star"}>
