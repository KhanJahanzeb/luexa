    ...
    $.fn.bigSlide = function(options) {
        ...
        var view = {
            ...
            destroy: function() {
                ...
                menuLink.removeClass(settings.activeBtn).off('click.bigSlide touchstart.bigSlide');
                this.$menu = null;
                this.$push = null;
            },
            toggleOpen: function() {
...
function lazzyload() {
    ...
    //  $('a[data-imghref]').each(function(){count++;$this=$(this);winscr=$(window).scrollTop()+$(window).height();offset=$(this).offset().top;if(winscr>=offset&&offset!=0){if(!$this.hasClass('imgadded'))
    //   {var isrchref=$this.attr('data-imghref');$this.attr('href',isrchref);$this.addClass('imgadded');
    ...
    $('a[data-href]').each(function() {
        ...
        if (winscr >= offset && offset != 0) {
            if (!$this.hasClass('imgadded')) {
                var isrchref = $this.attr('data-href');
    ...
    $('[data-img]').each(function() {
        ...
        if (winscr >= offset) {
            if (!$this.hasClass('bgadded')) {
                var isrcc = $this.attr('data-img');
                $this.css('background-image', isrcc);
